...
#pragma endregion
	...
	public: [TestMethod]
			void deserializeAndReselalizzeTest()
			{
				...
				Messaggi^  target = (gcnew Messaggi(Mess::MissionPlan)); 
				...
				Messaggi^  statolinea = (gcnew Messaggi(Mess::StatoLineaIXL)); 
				...
				Messaggi^  statolineaatc = (gcnew Messaggi(Mess::StatoLineaATC)); 
				...
				Messaggi^  Presentazione = (gcnew Messaggi(Mess::Presentation)); 
				...
				//Deserializza wakeup
				Messaggi^  wakeup = (gcnew Messaggi(Mess::UnconditionCommand)); 
				...
				//Deserializza TRN
				Messaggi^  trn = (gcnew Messaggi(Mess::UnconditionCommand)); 
				...
				Messaggi^  missionpln = (gcnew Messaggi(Mess::MissionPlan)); 
			...
			//	CollectionAssert::AreEqual(bbytesd,Bytess);
				...
				//Deserializza ack
				Messaggi^  ack = (gcnew Messaggi(Mess::Acknol)); 
				...
				//
				//Deserializza cmdixl
				Messaggi^  cmdixl = (gcnew Messaggi(Mess::ComandoItinerari)); 
				...
				Messaggi^  cmdblocco = (gcnew Messaggi(Mess::ComandoBlocco)); 
				...
				//Deserializza fault
				Messaggi^  mfault = (gcnew Messaggi(Mess::FaultReportingIXL)); 
...
public: [TestMethod]
		void getSizeTest()
		{
			...
			target = (gcnew Messaggi(Mess::FaultReportingIXL)); 
			expected = 12; 
			actual = target->getSize();
			Assert::AreEqual(expected, actual);
