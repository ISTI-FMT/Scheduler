...
#ping 127.0.0.1 -n 5 > nul
START  python simulaTreno.py Treno65316percorso1154.txt 0
#ping 127.0.0.1 -n 5 > nul
...
#ping 127.0.0.1 -n 5 > nul
#START  python simulaTreno.py Treno65551percorso1166.txt 0
START  python simulaTreno.py  Treno65666percorso1166.txt 0 