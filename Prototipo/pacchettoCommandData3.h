...
public:
	...
	void setNID_OPERATIONAL(int NID){data.structuredCommandData.NID_OPERATIONAL = NID;};
	int getNID_OPERATIONAL(){return data.structuredCommandData.NID_OPERATIONAL;};
